if contains_package "/debootstrap/desktop/15-packages-custom.txt" "lff-picture-selector"; then
	...
	download "https://github.com/LFF5644/PictureSelector/releases/download/v2.0/PictureSelectorV2.zip" "/tmp/PictureSelectorV2.zip"
	...
	download "https://github.com/LFF5644/PictureSelector/releases/download/v2.0/pictureSelectorV2.service" "/etc/systemd/user/pictureSelectorV2.service"
