if [ "$INSTALL_DESKTOP_PACKAGES" = "true" ] && contains_package "/debootstrap/desktop/15-packages-custom.txt" "spotify-client"; then
	...
	apt_update && apt_install_package spotify-client
fi
