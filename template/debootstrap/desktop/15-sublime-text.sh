if [ "$INSTALL_DESKTOP_PACKAGES" = "true" ] && contains_package "/debootstrap/desktop/15-packages-custom.txt" "sublime-text"; then
	channel="stable"
	...
	apt_update && apt_install_package sublime-text
fi
